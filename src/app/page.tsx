    ...
    <AuthChrome>
      <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 sm:py-16">
        <section className="max-w-2xl space-y-5">
          <Badge variant="secondary">Private construction portal</Badge>
          <h1 className="text-display text-foreground">Kavin Illam</h1>
        ...
        <section className="mt-12 grid gap-4 sm:grid-cols-3">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Isolated members, settings, and finance per project.
              </CardDescription>
            </CardHeader>
            <CardContent className="text-muted-foreground text-sm">
              Switch projects from the sidebar without mixing data.
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Authorization first</CardTitle>
              <CardDescription>
                Membership and permission checks run on the server.
              </CardDescription>
            </CardHeader>
            <CardContent className="text-muted-foreground text-sm">
              Private records never leak into shared totals, exports, or
              collaborator views.
            </CardContent>
          </Card>
        </section>
